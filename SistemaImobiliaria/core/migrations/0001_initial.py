# Generated by Django 2.0.7 on 2019-04-10 01:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_imovel', models.IntegerField(db_column='Id_imovel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_propietario', models.ForeignKey(blank=True, db_column='id_propietario', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.Propietario')),
            ],
            options={
                'db_table': 'venda',
                'managed': True,
        ...
        migrations.AddField(
            ...
            name='id_propietario',
            field=models.ForeignKey(blank=True, db_column='id_propietario', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.Propietario'),
        ),
        migrations.AddField(
            model_name='imovel',
            name='id_propietario',
        ...
        migrations.AddField(
            model_name='contato',
            name='propietario',
            field=models.ForeignKey(blank=True, db_column='propietario', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.Propietario'),
        ),
        migrations.AddField(
            model_name='boleto',
            name='id_cliente',
